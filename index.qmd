...
format:
  revealjs: 
    ...
    css: styles.css
    footer: '<https://ronaldvisser.github.io/TextMiningUrbanFarming_IWGP2025>'
resources:
...
-   NOT: too general terms

-   NOT: ambivalent terms
:::
...
-   northern seventeenth century expansion:
    -   horticulture
    -   animal husbandry
    -   fish farming
...
![[Sites plotted on the Van Deventer map in @fischer2021, Figure 8.19]](images/Figure_8.19_Groningen.png)
...
-   Defintion of keywords is important
    -   Rating
    -   Valuing
-   Text mining save work, but you still need to read reports
